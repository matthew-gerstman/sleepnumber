...
export declare class ExamplePlatformAccessory {
    ...
    constructor(platform: SleepNumberHomebridgePlatform, accessory: PlatformAccessory);
    /**
...
export declare class SleepNumberFlexFrame {
    ...
    constructor(platform: SleepNumberHomebridgePlatform, accessory: PlatformAccessory, sleepNumberAPI: SleepNumberAPI);
    __delay__(timer: number): Promise<unknown>;
    get log(): import("homebridge").Logger;
    waitForBedToStopMoving: () => Promise<void>;
    setFoundation: any;
    getFoundation: (callback: any) => any;
